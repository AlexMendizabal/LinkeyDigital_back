...
from profile.models import CustomerUserPhone, PhoneDto
from profile.services import ContactService


class CustomerUserPhoneSerializer(serializers.ModelSerializer):
    class Meta:
...
class CustomerUserPhoneViewSet(APIView):
    def get(self, request, pk=None):
        ...
        try:
            response = contact_service.get_phone(pk, request.user.id)
    ...
    def post(self, request):
        ...
        serializer = CustomerUserPhoneSerializer(data=request.data)
        ...
        try:
            response = contact_service.create_or_update_phone(dto)
        except Exception as e:
