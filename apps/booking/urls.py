...
from apps.booking.views import BookingViewset, ConfBookingViewset, PublicBookingViewset, PublicConfBookingViewset \
    ,PUblicSearchBookingViewset, PublicBusyViewset
from apps.booking.views.booking_settings_viewset import ConfBookingListView, ConfBookingCreateView,ConfBookingUpdateView,ConfBookingDeleteView,ConfBookingRetrieveView
