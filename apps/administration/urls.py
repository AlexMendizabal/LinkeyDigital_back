...
from apps.administration.views import LicenciaViewSet, LicenciaSuperViewSet, LicenciaCoonectViewSet,\
      LicenciaAdminViewSet, BlockersUsersViewSet, EditableUsersViewSet

from apps.administration.views.licencias_viewset import ListAdminViewSet
