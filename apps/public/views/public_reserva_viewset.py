...
from apps.public.services import Reservaservices
...
class CustomerUserReservaViewSet(APIView):
    ...
    def post(self, request, public_id):
        ...
        serializers = CustomerReservaserializers(data=request.data)
        ...
        try:
            response = reserva_services.create_or_update_reserva(dto)
