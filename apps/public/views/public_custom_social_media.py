...
class PublicCustomerUserCustomSocialMediaViewSet(APIView):
    ...
    def post(self, request, public_id):
        ...
        customer_user_public_custom_social_media_services = PublicSocialMediaservices()
        try:
            customer_user_public_custom_social_media_services.visit_custom_social_media(customer_user_custom_social_media_id,
                                                                    customer_user.pk)
        except Exception as e:
