...
from apps.profile.views import CustomerUserProfileViewSet, CustomerUserWhatsappViewSet, CustomerUserReservaViewSet,\
...
from apps.profile.views.customer_user_profile_log import view_profile_log
