...
from apps.pay.utilitiesPay import TransactionserializersForAll
from apps.pay.models import Transaction
from apps.pay.serializers import AllTransactionserializers
class AllTransactionsView(APIView):
    def get(self, request):
        try:
            ...
            transaction_serializers = AllTransactionserializers(transactions, many=True)
