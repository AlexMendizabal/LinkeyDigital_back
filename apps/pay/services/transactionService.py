...
from apps.pay.models import Transaction, DetalleTransaction, Discount, DetalleTransaction
from apps.pay.models import Productos

from apps.administration.views import Utilities
from apps.authentication.views import create_users_in_threads
from apps.contact.services import SendEmail
from apps.contact import GetHtmlForEmail
