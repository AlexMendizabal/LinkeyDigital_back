...
from apps.client_contact.views.client_contact_config_viewset import ConfigurationAPIView
from apps.client_contact.views.client_contact_config_public_viewset import ConfigurationDetail
from apps.client_contact.views.client_contact_viewset import RegisterListCreateAPIView, RegisterRetrieveUpdateDestroyAPIView
from apps.client_contact.views.client_contact_public_viewset import RegisterCreateAPIView
from apps.client_contact.views.multiple_contact_config_viewset import MultipleConfigurationViewSet
